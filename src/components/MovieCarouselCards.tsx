    ...
    return (
        <div className="movie-carousel-container">
            ...
            <div className="movie-carousel-rating">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="movie-carousel-star-svg" aria-hidden="true">
                ...
                <span className="movie-carousel-score">{rating}</span>
            </div>
